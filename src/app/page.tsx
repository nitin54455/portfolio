...
export default function Home() {
  return (
    <main className="bg-gradient-to-b from-white to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white min-h-screen">
            ...
            <div className="relative z-10 flex flex-col-reverse md:flex-row gap-10 items-center">
              <div className="md:w-2/3">
                ...
                <p className="text-lg leading-relaxed mb-8 text-gray-700 dark:text-gray-300">
                  My technical journey spans across various technologies and frameworks, allowing me to build robust and scalable applications. I'm passionate about creating user-centric solutions and continuously expanding my knowledge in emerging technologies.
                </p>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-8 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-blue-100 to-transparent dark:from-blue-900/20 dark:to-transparent rounded-bl-full -z-0 opacity-70"></div>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 relative z-10">
              <div>
                <h3 className="text-xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-700 text-blue-600 dark:text-blue-400">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-700 text-indigo-600 dark:text-indigo-400">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-700 text-emerald-600 dark:text-emerald-400">
                    Tools & Technologies
                  </h3>
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <span 
                        key={skill} 
                        className="bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 px-4 py-2 rounded-full text-sm font-medium inline-block animate-pulse-slow hover:animate-none"
                      >
                        {skill}
                      </span>
                    ))}
                ...
                <div>
                  <h3 className="text-xl font-bold mb-6 pb-2 border-b border-gray-200 dark:border-gray-700 text-amber-600 dark:text-amber-400">
                    Soft Skills
                  </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <div className="mt-6">
                  <a href="#" className="inline-flex items-center text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 font-medium">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <div className="mt-6">
                  <a href="#" className="inline-flex items-center text-pink-600 dark:text-pink-400 hover:text-pink-800 dark:hover:text-pink-300 font-medium">
                    <span>Project Details</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </svg>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <div className="mt-6">
                  <a href="#" className="inline-flex items-center text-teal-600 dark:text-teal-400 hover:text-teal-800 dark:hover:text-teal-300 font-medium">
                    <span>Project Details</span>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                    </svg>
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-blue-950/20 dark:to-purple-950/20 opacity-80"></div>
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-blue-200/30 dark:bg-blue-900/10 rounded-full blur-3xl"></div>
        <div className="absolute -top-32 -right-32 w-96 h-96 bg-purple-200/30 dark:bg-purple-900/10 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { 
                title: "CTF Hackathon – TechnOcean SCSE LPU", 
                org: "LPU", 
                date: "Mar 2024",
                icon: (
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 md:p-12 overflow-hidden relative">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="md:w-1/2 bg-gray-50 dark:bg-gray-700/30 p-6 rounded-xl">
                <h3 className="text-xl font-bold mb-4 text-indigo-600 dark:text-indigo-400">Quick Connect</h3>
                ...
                <div className="space-y-4">
                  ...
                  <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-green-50 dark:bg-green-900/30 rounded-lg hover:bg-green-100 dark:hover:bg-green-800/30 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="text-green-600 dark:text-green-400" viewBox="0 0 16 16">
                      <path d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"/>
                      <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5L9.5 0zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"/>
                    </svg>
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 border-l-4 border-blue-500">
